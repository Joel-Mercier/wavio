...
export const getMusicFolders = async () => {
  try {
    const rsp = await openSubsonicApiInstance.get<OpenSubsonicResponse<{ musicFolders: MusicFolders }>>(
...
export const getArtistInfo = async (id: string) => {
  try {
    const rsp = await openSubsonicApiInstance.get<OpenSubsonicResponse<{ artistInfo: ArtistInfo }>>(
      "/rest/getArtistInfo",
      {
        params: {
          id
...
export const getArtistInfo2 = async (id: string) => {
  try {
    const rsp = await openSubsonicApiInstance.get<OpenSubsonicResponse<{ artistInfo2: ArtistInfo2 }>>(
      "/rest/getArtistInfo2",
      {
        params: {
          id
...
export const getArtists = async ({ musicFolderId }: { musicFolderId?: string }) => {
  try {
    ...
    const rsp = await openSubsonicApiInstance.get<OpenSubsonicResponse<{ artists: ArtistsID3 }>>(
      "/rest/getArtists",
      {
        params: {
          musicFolderId
...
export const getGenres = async () => {
  try {
    ...
    const rsp = await openSubsonicApiInstance.get<OpenSubsonicResponse<{ genres: Genres }>>(
      "/rest/getGenres",
      {
        params: {}
      }
...
export const getIndexes = async ({ musicFolderId, ifModifiedSince }: { musicFolderId?: string, ifModifiedSince?: number }) => {
  try {
    ...
    const rsp = await openSubsonicApiInstance.get<OpenSubsonicResponse<{ indexes: Indexes }>>(
      "/rest/getIndexes",
      {
        params: {
          musicFolderId,
...
export const getMusicDirectory = async (id: string) => {
  try {
    ...
    const rsp = await openSubsonicApiInstance.get<OpenSubsonicResponse<{ directory: Directory }>>(
...
export const getPodcastEpisode = async (id: string) => {
  try {
    ...
    const rsp = await openSubsonicApiInstance.get<OpenSubsonicResponse<{ podcastEpisode: PodcastEpisode }>>(
...
export const getSimilarSongs = async (id: string, { count }: { count?: number }) => {
  try {
    ...
    const rsp = await openSubsonicApiInstance.get<OpenSubsonicResponse<{ similarSongs: SimilarSongs }>>(
...
export const getSimilarSongs2 = async (id: string, { count }: { count?: number }) => {
  try {
    ...
    const rsp = await openSubsonicApiInstance.get<OpenSubsonicResponse<{ similarSongs2: SimilarSongs2 }>>(
...
export const getSong = async (id: string) => {
  try {
    ...
    const rsp = await openSubsonicApiInstance.get<OpenSubsonicResponse<{ song: Child }>>(
      "/rest/getSong",
      {
        params: {
          id
...
export const getTopSongs = async (artist: string, { count }: { count?: number }) => {
  try {
    ...
    const rsp = await openSubsonicApiInstance.get<OpenSubsonicResponse<{ topSongs: TopSongs }>>(
      "/rest/getTopSongs",
      {
        params: {
          artist,
...
export const getVideoInfo = async (id: string) => {
  try {
    ...
    const rsp = await openSubsonicApiInstance.get<OpenSubsonicResponse<{ videoInfo: VideoInfo }>>(
      "/rest/getVideoInfo",
      {
        params: {
          id
...
export const getVideos = async () => {
  try {
    ...
    const rsp = await openSubsonicApiInstance.get<OpenSubsonicResponse<{ videos: Videos }>>(
      "/rest/getVideos",
      {
        params: {
        }
