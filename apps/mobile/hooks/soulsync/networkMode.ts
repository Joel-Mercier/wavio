// SoulSync runs on its own host, unrelated to the music server that drives
// react-query's onlineManager (device online AND active server reachable).
// Without this, a music server that is merely unreachable pauses every SoulSync
...
export const SOULSYNC_NETWORK_MODE = "always" as const;
