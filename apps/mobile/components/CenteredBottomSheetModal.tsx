...
>(({ style, onChange, ...props }, ref) => {
  ...
  // A dynamically-sized sheet with many rows can grow tall enough that its drag
  // handle reaches the top edge, leaving nothing to drag down and fighting the
  // OS notification-tray pull. Cap the content height at ~80% of the screen so
  // there is always backdrop left to tap and room to swipe; past that the
  // sheet's scroll view takes over.
