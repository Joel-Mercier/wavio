...
import PodcastIcon from "lucide-react-native/dist/esm/icons/mic-signal.mjs";
...
export default function PlayerSheets({
  ...
  const handleAudioMuseSongPathPress = () => {
    ...
    router.replace({
      ...
      params: {
        startId: playingTrack.id,
        startTitle: playingTrack.title ?? "",
        startAuthor: playingTrack.artist ?? "",
      },
    });
  };
