...
function ErrorFallback({ onRetry }: { onRetry: () => void }) {
	...
	return (
		<Box className="flex-1 items-center justify-center px-6 bg-primary-0">
			<VStack className="items-center gap-y-4 max-w-sm">
				<Icon as={TriangleAlert} className="text-primary-300 w-12 h-12" />
				<Heading className="text-primary-950 text-center" size="lg">
				...
				<VStack className="items-center gap-y-3 mt-4 w-full">
					<FadeOutScaleDown
						onPress={onRetry}
						className="rounded-full bg-primary-950 px-8 py-3"
					>
						<Text className="text-primary-0 font-bold">
