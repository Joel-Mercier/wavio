...
export const getMusicFolders = dispatch(S.getMusicFolders, J.getMusicFolders);
export const getAlbum = dispatch(S.getAlbum, J.getAlbum);
...
export const getGenres = dispatch(S.getGenres, J.getGenres);
export const getIndexes = dispatch(S.getIndexes, J.getIndexes);
...
export const getSong = dispatch(S.getSong, J.getSong);
