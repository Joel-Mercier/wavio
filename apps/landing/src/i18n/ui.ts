...
export const ui = {
  ...
  ru: {
    ...
    showcase: {
      ...
      sub: 'Интерфейс заточен под то, что ты делаешь чаще всего. Ищи, слушай, ставь в очередь, настраивай, скачивай — и забывай, что приложение вообще здесь.',
    },
    final: {
    ...
    privacy: {
      ...
      sections: [
        ...
        },
        {
          ...
          body: `<p><strong>Ничего личного.</strong> В Wavio нет аккаунтов, профилей, рекламных SDK, поведенческой аналитики или социальных трекеров. Мы не управляем никаким сервером, который хранит информацию о том, кто ты и что ты слушаешь.</p>
        ...
        },
        {
          ...
          body: `<p>Рабочие сборки Wavio используют <a href="https://sentry.io/" target="_blank" rel="noopener" class="text-accent hover:underline">Sentry</a>, чтобы сообщать о вылетах и непредвиденных ошибках, чтобы мы могли их исправить. Каждый отчет включает технический контекст: стек вызовов, версию приложения, модель устройства, версию Android и IP-адрес отправителя.</p>
            <p>Мы не присваиваем тебе идентификатор, не отслеживаем, какие экраны ты посещаешь, не логируем, что ты слушаешь, и не строим твой профиль. Отчеты нужны только для поиска багов и хранятся согласно <a href="https://sentry.io/privacy/" target="_blank" rel="noopener" class="text-accent hover:underline">политике хранения данных Sentry</a>.</p>`,
        },
        {
          num: '06',
          ...
          <ul>
            ...
            <li><strong>Foreground service и воспроизведение медиа</strong> чтобы музыка играла, когда экран выключен.</li>
        ...
        },
        {
          ...
          body: `<p>Если эта политика изменится, обновленная версия будет опубликована здесь и анонсирована в release notes проекта на GitHub.</p>`,
        },
        {
          num: '10',
          title: 'Контакты',
          body: `<p>Есть вопросы, замечания или просто любопытно? Открывай issue в <a href="${GITHUB_URL}/issues" target="_blank" rel="noopener" class="text-accent hover:underline">репозитории Wavio на GitHub</a>, и кто-нибудь из мейнтейнеров ответит тебе.</p>`,
        },
      ],
    },
  },
